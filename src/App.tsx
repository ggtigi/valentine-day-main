    ...
    return (
        <div className="main">
            {isValentine ? (
                <div>
                    <h2 className="title"> 
                        Любимая, я рад что смог познакомиться с тобой и то что провожу с тобой каждый свой день, спасибо что появилась в моей жизни, я тебя очень сильно люблю. С праздником тебя! &hearts; </h2>
